 ...
 * @author FASARLJP
 */
public class ModificarAlumnos extends javax.swing.JDialog {

    /**
     * Creates new form ModificarAlumnos
     */
    public ModificarAlumnos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarAlumnos dialog = new ModificarAlumnos(new javax.swing.JFrame(), true);
